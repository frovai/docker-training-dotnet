...
docker rm $(docker ps -aq) ## Example Linux command to delete all containers listed on the filter
```
...
```
docker rmi [imageid]
docker rmi $(docker images -aq) ## Example Linux command to delete all images filtered
```
